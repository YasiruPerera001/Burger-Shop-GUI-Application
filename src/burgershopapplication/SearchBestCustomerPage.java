...
public class SearchBestCustomerPage extends javax.swing.JFrame {
    ...
    public SearchBestCustomerPage(BurgerCollection b1) {
        initComponents();
        setSize(800, 500);
        setLocationRelativeTo(null);
        this.b1 = b1;

        String[] columnsName = {"Customer ID", "QTY", "Total"};
        temp = new Burger[b1.getBurgersArray().length];
        
        temp = b1.removeDuplicates(temp);
        
        b1.sort(temp);
        
        dtm = b1.addRowData(temp,dtm,columnsName);
    ...
    private void initComponents() {
        ...
        banner.setText("Search Best Customer");
