...
public class PreparingOrdersPage extends javax.swing.JFrame {
    ...
    public PreparingOrdersPage(BurgerCollection b1) {
        initComponents();
        setSize(800, 500);
        ...
        for (int i = 0; i < rowData.length; i++) {
            if (temp[i].getStatus() == Burger.PREPARING) {
    ...
    private void initComponents() {
        ...
        banner.setText("Preparing Orders");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PreparingOrdersPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new PreparingOrdersPage(b1).setVisible(true);
            }
        });
    }
