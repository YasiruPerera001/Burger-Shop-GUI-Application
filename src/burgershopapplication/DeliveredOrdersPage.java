...
public class DeliveredOrdersPage extends javax.swing.JFrame {
    ...
    public DeliveredOrdersPage(BurgerCollection b1) {
        initComponents();
        setSize(800, 500);
        ...
        for (int i = 0; i < rowData.length; i++) {
            if (temp[i].getStatus() == Burger.DELIVERED) {
    ...
    private void initComponents() {
        ...
        banner.setText("Delivered Orders");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new DeliveredOrdersPage(b1).setVisible(true);
            }
        });
    }
